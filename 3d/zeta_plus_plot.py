# nohup python $WORK/tc_analyze/3d/zeta_plus_plot.py $style &
import numpy as np
...
def process_t(t):
    ...
    for z in z_list:
        ...
        pc = ax.contourf(X_cut,Y_cut,data_masked,levels=np.arange(0,0.0044,0.0004),cmap="rainbow",extend="max")
        ...
        ax.set_title(f"t = {t}h, z = {int(vgrid[z]*1e-2)*1e-1}km")
