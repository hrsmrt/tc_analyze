...
if SIGMA > 0:
    OUTPUT_DIR = config.get_fig_path("3d", "whole_domain_two_levels", f"{VARNAME}_z{Z1}_z{Z2}_smooth{SIGMA:.1f}")
else:
    OUTPUT_DIR = config.get_fig_path("3d", "whole_domain_two_levels", f"{VARNAME}_z{Z1}_z{Z2}")
