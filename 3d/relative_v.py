...
center_v_list[1:-1] = (center_x_list[2:] - center_x_list[:-2]) / (2 * dt)
center_v_list[0] = (center_x_list[1] - center_x_list[0]) / (dt)
center_v_list[-1] = (center_x_list[-1] - center_x_list[-2]) / (dt)

data_memmap = np.memmap(f"{input_folder}ms_v.grd",dtype=">f4",mode="r",shape=(nt,nz,ny,nx))
