# python $WORK/tc_analyze/analyze/2d/whole_domain.py varname $style
import os
import numpy as np
...
dir = f"./fig/2d/whole_domain/{varname}/"
...
for t in range(nt):
    ...
    match varname:
        ...
        case "sa_slp":
            levels = np.arange(990, 1016 + 1, 1)   # 1 hPa間隔
            c = ax.contour(
                X,
                Y,
                data / 100,
