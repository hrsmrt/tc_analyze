...
folder_input = "./data/2d/wind10m_tangential/"
output_dir = "./fig/2d/vortex_region/wind10m_tangential/"
...
def process_t(t):
    ...
    c = ax.contourf(X_cut*1e-3,Y_cut*1e-3,data_cut,cmap=custom_cmap,levels=np.arange(0,55,5),extend='max')
