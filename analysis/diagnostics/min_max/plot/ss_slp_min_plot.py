...
# python $WORK/tc_analyze/analysis/diagnostics/min_max/plot/ss_slp_min_plot.py $style
import os
...
folder = config.get_domain_path("diagnostics", "min_max", data_type="fig")
os.makedirs(folder, exist_ok=True)

# データの読み込み (npz/npy fallback)
data_path_npz = os.path.join(config.get_domain_path("diagnostics", "min_max"), "ss_slp_min.npz")
data_path_npy = os.path.join(config.get_domain_path("diagnostics", "min_max"), "ss_slp_min.npy")
