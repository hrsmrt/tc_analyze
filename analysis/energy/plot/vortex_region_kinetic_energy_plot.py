...
"""
# python $WORK/tc_analyze/analysis/energy/plot/vortex_region_kinetic_energy_plot.py $style
import os
...
OUTPUT_DIR = config.get_tc_centric_path("energy", "kinetic_energy", data_type="fig")
...
def process_t(t):
    ...
    for z in z_list:
        data_cut = grid.extract_vortex_region(v_squared[z], center_x, center_y, EXTENT)
        # === 中心から半径 R 以内のみプロット ===
