...
"""
# python $WORK/tc_analyze/analysis/energy/plot/whole_domain_internal_energy_plot.py $style
import os
...
OUTPUT_DIR = config.get_domain_path("energy", "whole_domain/internal_energy", data_type="fig")
