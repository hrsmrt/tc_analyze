"""Plot 10m wind speed over vortex region."""
# python $WORK/tc_analyze/analysis/vortex_region/2d/plot/ss_wind10m_abs_vortex_region.py $style
import os
...
OUTPUT_DIR = config.get_tc_centric_path("vortex_region", "2d/wind10m_abs", data_type="fig")
