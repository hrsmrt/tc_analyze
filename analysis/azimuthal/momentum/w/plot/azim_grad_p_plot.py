...
output_folder = config.get_fig_path("azim", "eq_momentum_w", "grad_p")

os.makedirs(output_folder, exist_ok=True)


def process_t(t):
    data = np.load(os.path.join(config.get_data_path('azim', 'eq_momentum_w'), f"grad_p/t{str(t).zfill(3)}.npy"))
