...
output_folder = config.get_fig_path("azim", "eq_momentum_u", "du_dz")

os.makedirs(output_folder, exist_ok=True)


def process_t(t):
    data = np.load(os.path.join(config.get_data_path('azim', 'eq_momentum_u', 'du_dz'), f"t{str(t).zfill(3)}.npy"))
