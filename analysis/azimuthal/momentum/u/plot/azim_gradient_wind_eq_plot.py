...
sample_data_path = config.get_tc_centric_path("azimuthal", "momentum/u/gradient_wind_eq")
...
def process_t(t):
    ...
    data_path = config.get_tc_centric_path("azimuthal", "momentum/u/gradient_wind_eq")
