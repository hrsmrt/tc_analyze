# python $WORK/tc_analyze/analysis/azimuthal/momentum/u/plot/azim_centrifugal_plot.py $style
import os
...
def process_t(t):
    ...
    data_path = config.get_tc_centric_path("azimuthal", "momentum/u/centrifugal")
    ...
    ax.set_title(f"遠心力 t = {config.time_list[t]} hour")
    ax.set_ylim([0, 20])
    ax.set_xlabel("半径 [km]")
    ax.set_ylabel("高度 [km]")
