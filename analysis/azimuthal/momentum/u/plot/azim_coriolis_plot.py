# python $WORK/tc_analyze/analysis/azimuthal/momentum/u/plot/azim_coriolis_plot.py $style
import os
...
output_folder = config.get_tc_centric_path("azimuthal", "momentum/u/coriolis", data_type="fig")

os.makedirs(output_folder, exist_ok=True)


def process_t(t):
    data = np.load(os.path.join(config.get_tc_centric_path("azimuthal", "momentum/u/coriolis"), f"t{str(t).zfill(3)}.npy"))
