...
output_folder = config.get_tc_centric_path("azimuthal", "momentum/u/gradient_wind_eq")
...
def process_t(t):
    ...
    np.savez(
        ...
        data=gradient_wind_eq,
        varname="gradient_wind_eq",
        method="gradient_wind_balance",
