...
# グリッド設定：データから実際のビン数を取得 (.npz/.npy fallback)
sample_data_path = config.get_tc_centric_path("azimuthal", "eliassen/buoyancy")
...
def process_t(t):
    # Load data (.npz/.npy fallback)
    data_path = config.get_tc_centric_path("azimuthal", "eliassen/buoyancy")
