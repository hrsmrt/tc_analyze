# python $WORK/tc_analyze/analysis/azimuthal/eliassen/plot/azim_gamma_plot.py $style
...
sample_data_path = config.get_tc_centric_path("azimuthal", "eliassen/gamma")
...
def process_t(t):
    ...
    data_path = config.get_tc_centric_path("azimuthal", "eliassen/gamma")
