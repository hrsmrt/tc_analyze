...
folder1 = config.get_tc_centric_path("azimuthal", "basic/phy_radial")
folder2 = config.get_tc_centric_path("azimuthal", "basic/phy_tangential")
...
data_all_u = np.memmap(
    f"{config.input_folder}ms_phy_du.grd",
    dtype=">f4",
    mode="r",
    shape=(config.nt, config.nz, config.ny, config.nx),
)
data_all_v = np.memmap(
    f"{config.input_folder}ms_phy_dv.grd",
    dtype=">f4",
    mode="r",
    shape=(config.nt, config.nz, config.ny, config.nx),
)
