# python $WORK/tc_analyze/analysis/azimuthal/basic/calc/azim_wind_calc.py
import os
...
folder1 = config.get_tc_centric_path("azimuthal", "basic/wind_radial")
folder2 = config.get_tc_centric_path("azimuthal", "basic/wind_tangential")
