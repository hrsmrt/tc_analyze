# python $WORK/tc_analyze/analysis/azimuthal/basic/plot/azim_stream2_plot.py $style
...
output_folder = config.get_tc_centric_path("azimuthal", "basic/stream2", data_type="fig")
os.makedirs(output_folder, exist_ok=True)


def process_t(t):
    data = np.load(os.path.join(config.get_tc_centric_path("azimuthal", "basic/stream2"), f"t{str(t).zfill(3)}.npy"))
