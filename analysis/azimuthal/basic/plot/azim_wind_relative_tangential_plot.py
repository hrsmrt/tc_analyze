...
python $WORK/tc_analyze/azim_mean/azim_wind_relative_tangential_plot.py $style
"""
import os
...
OUTPUT_FOLDER = config.get_tc_centric_path("azimuthal", "basic/wind_relative_tangential", data_type="fig")
