...
# python $WORK/tc_analyze/analysis/center/mass.py $style
import os
...
output_folder = config.get_center_path("ss_slp", data_type="fig")
...
fig.savefig(os.path.join(output_folder, "mass_time_series.png"))
plt.close()
