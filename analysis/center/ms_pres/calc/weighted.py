...
- Search within r_search from ss_slp center
...
def main():
    ...
    for z_idx, z in enumerate(range(z_first, z_last + 1)):
        ...
        z_filename = f"weighted_center_z{z:03d}.npz"
        z_metadata = {
    ...
    print(f"Saved {n_z} individual z-level files: weighted_center_z???.npz")
...
def process_t(t, z, data_memmap, X, Y, config, ss_slp_center, r_search, r_refine):
    ...
    Args:
        ...
        r_search: Initial search radius from ss_slp center
