"""Plot horizontal distribution of tropical cyclone center by height (smoothed_minimum method, z≤20km).
...
Usage:
    python $WORK/tc_analyze/analysis/center/ms_pres/plot/smoothed_center_horizontal_plot_20km.py
    python $WORK/tc_analyze/analysis/center/ms_pres/plot/smoothed_center_horizontal_plot_20km.py dark_background
"""
import os
import matplotlib
...
def process_t(t):
    ...
    title = f"TC Center by Height (smoothed_minimum, z≤{z_max_km}km)\nt = {time_hour:.0f} hour"
    ...
    output_path = os.path.join(output_dir, f"horizontal_smoothed_20km_t{str(t).zfill(3)}.png")
...
print(f"Saved horizontal scatter plots (z≤{z_max_km}km): {output_dir}/horizontal_smoothed_20km_t*.png")
