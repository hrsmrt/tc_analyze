...
"""
# python $WORK/tc_analyze/analysis/whole_domain/3d/plot/total_energy_density_plot.py $style
import os
...
OUTPUT_DIR = config.get_domain_path("whole_domain", "3d/total_energy_density", data_type="fig")
