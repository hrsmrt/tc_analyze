...
# python $WORK/tc_analyze/analysis/whole_domain/2d/plot/whole_domain_with_low2_plot.py varname $style
import os
import sys
...
OUTPUT_DIR = config.get_domain_path("whole_domain", f"2d/whole_domain_with_low2/{VARNAME}", data_type="fig")
