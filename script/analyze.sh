...
run_3d() {
    ...
    run_cmd "python ${TC_ANALYZE}/3d/vortex_region_r250.py ${STYLE}"
    run_cmd "python ${TC_ANALYZE}/3d/whole_domain_wind_uv_abs_plot.py ${STYLE}"
    run_cmd "python ${TC_ANALYZE}/3d/whole_domain_with_center_plot.py ${STYLE}"
...
run_2d() {
    ...
    run_cmd "python ${TC_ANALYZE}/2d/whole_domain_with_center_plot.py ${STYLE}"
    run_cmd "python ${TC_ANALYZE}/2d/y_ave.py ${STYLE}"
}
...
run_azim() {
    ...
    run_cmd "python ${TC_ANALYZE}/azim_mean/azim_core_3d_plot.py ${STYLE}"
