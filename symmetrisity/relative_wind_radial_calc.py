...
def process_t(t):
    # 軸対称成分
    data_azim_mean = np.load(f"{config.get_data_path('azim', 'wind_relative_radial')}/t{str(t).zfill(3)}.npy")
    ...
    data = np.load(f"{config.get_data_path('3d', 'relative_wind_radial')}/t{str(t).zfill(3)}.npy")
