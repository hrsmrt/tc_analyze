# python $WORK/tc_analyze/azim_mean/eq_momentum_u/azim_centrifugal_plot.py $style
import os
import numpy as np
...
def process_t(t):
  ...
  c = ax.contourf(X,Y,data,cmap="bwr",levels=np.arange(-0.05,0.055,0.005),extend="both")
