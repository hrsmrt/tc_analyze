# python $WORK/tc_analyze/azim_mean/eq_momentum_u/azim_wdu_dz_plot.py $style
import os
import numpy as np
...
output_folder = "./fig/azim/eq_momentum_u/wdu_dz/"

os.makedirs(output_folder,exist_ok=True)

def process_t(t):
  data = np.load(f"./data/azim/eq_momentum_u/wdu_dz/t{str(t).zfill(3)}.npy")
  ...
  ax.set_title(rf"$w \partial u / \partial z$ t = {config.time_list[t]} hour")
  ax.set_ylim([0, 20])
  ax.set_xlabel("半径 [km]")
  ax.set_ylabel("高度 [km]")
