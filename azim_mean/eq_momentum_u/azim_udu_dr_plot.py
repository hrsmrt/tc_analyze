...
sample_data = np.load(f"./data/azim/eq_momentum_u/udu_dr/t{str(config.t_first).zfill(3)}.npy")
...
output_folder = "./fig/azim/eq_momentum_u/udu_dr/"

os.makedirs(output_folder, exist_ok=True)


def process_t(t):
    data = np.load(f"./data/azim/eq_momentum_u/udu_dr/t{str(t).zfill(3)}.npy")
